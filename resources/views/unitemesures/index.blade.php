...
<div class="row pt-2 pb-2">
    ...
    <div class="col-sm-3">
        <div class="btn-group float-sm-right">
            <button class="btn btn-primary m-1" data-toggle="modal" data-target="#smallsizemodal"><i
                    class="fa fa-plus"></i> Ajouter Unite Mesure</button>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('unitemesures.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomunite"
                                        class="form-control @error('nomunite') is-danger @enderror" id="input-5" required>
                                    @error('nomunite')
                                ...
                                <button type="submit"
                                    onclick="return confirm('Voulez vous enregistrer l\'unite de mesure ?')"
