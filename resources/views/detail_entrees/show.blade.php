        ...
        <div class="row pt-2 pb-2">
            ...
            <fieldset>
                ...
                <form role="form" action="{{url('detail_entrees')}}" method="POST">
                    ...
                    <div>
                        <a href="{{url('entrees')}}"><button class="btn btn-secondary" type="button" data-dismiss="modal"><i class="fa fa-backward"></i>
                            Retour</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="detail_entrees/{{$detail_entree->id}}/edit" class="btn btn-primary btn-sm"
                                                        title="Edit" class="d-inline">
