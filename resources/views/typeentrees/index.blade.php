...
<div class="row pt-2 pb-2">
    ...
    <div class="col-sm-3">
        <div class="btn-group float-sm-right">
            <button class="btn btn-primary mr-1" data-toggle="modal" data-target="#smallsizemodal"><i
                    class="fa fa-plus"></i> Ajouter Type Entrees</button>
                            ...
                            <form method="POST" action="{{ route('typeentrees.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomtype"
                                        class="form-control @error('nomtype') is-danger @enderror" id="input-5"
                                        required>
                                    @error('nomtype')
                                ...
                                <button type="submit" class="btn btn-primary"
                                    onclick="return confirm('Voulez vous enregistrer le type entree ?')">
